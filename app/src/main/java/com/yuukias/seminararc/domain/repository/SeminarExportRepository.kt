...
interface SeminarExportRepository {
    ...
    suspend fun writeBibTeX(seminarId: Long, uriString: String): ExportWriteResult
    suspend fun writeRis(seminarId: Long, uriString: String): ExportWriteResult
    ...
    suspend fun prepareBibTeXShare(seminarId: Long): ExportShareResult
    suspend fun prepareRisShare(seminarId: Long): ExportShareResult
